    ...
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <a href="/sobre">
            <img src="img/slogan2.png" class="d-block w-100" height="350px" width="100%" alt="arvore1">
          </a>
        </div>
        <div class="carousel-item" data-bs-interval="2000">
          <a href="/coleta">
            <img src="img/slogan1.png" class="d-block w-100" height="350px" width="100%" alt="arvore2">
          </a>
        </div>
        <div class="carousel-item" data-bs-interval="3000">
          <a href="/materiais">
            <img src="img/slogan3.png" class="d-block w-100" height="350px" width="100%" alt="arvore3">
          </a>
        </div>
      </div>
      ...
      <div class="album py-5">
        <div class="container">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <div class="col">
              <div class="card shadow-sm">
                <img src="img/Eletronicos.jpg" alt="">
                <div class="card-body">
                  ...
                  <div class="centro">
                    <a class="btn btn-outline-dark mt-auto" href="/materiais">Saiba mais</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="card shadow-sm">
                <img src="img/latinhas.png" alt="" height="100%" width="100%">
                <div class="card-body">
                  <div class="text-center">
                    <!-- Product name-->
                    <h5 class="fw-bolder">Latinhas</h5>
                  </div>
                  <p class="card-text">A "latinha" geralmente se refere a uma lata de alumínio, que é uma embalagem comum para bebidas e alimentos.
                    A reciclagem de latinhas economiza matérias-primas, como bauxita (para alumínio) e minério de ferro (para aço), ajudando na conservação de recursos.
                  </p>
                  <div class="centro">
                    <a class="btn btn-outline-dark mt-auto" href="/materiais">Saiba mais</a>
                  </div>
            ...
            <div class="col">
              <div class="card shadow-sm">
                <img src="img/medicamentos.jpg" alt="">
                <div class="card-body">
                  <div class="text-center">
                    <!-- Product name-->
                    <h5 class="fw-bolder">Medicamentos</h5>
                  </div>
                  <p class="card-text">Medicamentos que são considerados "lixos" geralmente se referem a medicamentos vencidos, não utilizados ou que foram descartados de maneira inadequada que
                    pode resultar na contaminação da água potável e de ecossistemas aquáticos.
                  </p>
                  <div class="centro">
                    <a class="btn btn-outline-dark mt-auto" href="/materiais">Saiba mais</a>
                  </div>
          ...
          <div class="botaomaterial d-flex justify-content-center">
              <a href="/login"  class="btn btn-light btn-lg">Clique aqui para mais materiais</a>
          </div>
